                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td align="center" st-image="banner-image">
                                    ...
                                    <div class="imgpop">
                                     <p>
                                     <img width="30%" border="0" height="auto" alt="logo" style="display:block; border:none; outline:none; text-decoration:none;width: 120px;" src="<?php echo base_url().'uploads/site/' ?>" class="bigimage"></p>
                                    </div>
                                 </td>
                              </tr>
                              <tr>
                        ...
                        <tr>
                           <td width="100%" >
                             <p style="padding: 0px 0px;color: #271906; font-size: 15px;line-height: 23px; font-family: 'Open Sans', sans-serif;font-weight: 400;"> 
                              Thank You for subscribing. Our team of expert will reach you soon. 
                             </p>
                           </td> 
                        </tr>
                              ...
                              <tr>
                                <td align="center" valign="middle" style=" text-align:center;line-height: 18px" st-content="viewonline">
                                  <p style="font-size: 11px; margin-bottom: 5px; color: #000;  font-family: 'Open Sans', sans-serif;">
                                      <span style="color:#000;font-weight:bolder;">Phone:</span> 7777777777
                                      <span style="color:#000;font-weight:bolder;">Email:</span><a style="color: #000;text-decoration: none;" href="mailto:ansarisahil00@gmail.com">ansarisahil00@gmail.com</a>
                                  </p> 
                                  <p style="font-size: 11px; margin-bottom: 5px; color: #000;  font-family: 'Open Sans', sans-serif;">
                                      <span style="color:#000;font-weight:bolder;">Web:</span> 
                                      <a style="color: #000;text-decoration: none;" href="<?php echo 'https://test.world' ?>">Sahil Ansari</a>
                                  </p> 
                                </td>
                              </tr>                           
                               <tr>
