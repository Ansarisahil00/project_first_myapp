      ...
      <div class="row">
        <div class="col-lg-7">
          <div class="caption header-text">
            ...
            <span>or</span>
            <div class="second-button"><a href="<?php echo base_url() ?>faqs">Check our FAQs</a></div>
          </div>
        </div>
      </div>
    </div>
...
<!-- <div class="container">
    <div class="row">
        ...
        <p> Lorem ipsum, dolor sit amet consectetur adipisicing elit. Fugiat, qui officiis ipsam nemo omnis sequi harum
            rem esse ad nam totam ullam quam quia? Asperiores sunt sit ipsum quod perspiciatis, nostrum quia quae
            ratione.</p>
    </div>
</div> -->